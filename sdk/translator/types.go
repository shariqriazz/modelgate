...
// It returns a slice of byte slices, where each entry is a chunk of the converted streaming response.
...
// It returns the converted response as a byte slice.
...
// It takes a context and the token count as an int64, and returns the transformed token count as a byte slice.
