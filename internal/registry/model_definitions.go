...
func GetOpenAIModels() []*ModelInfo {
	return []*ModelInfo{
		...
		},
		{
			...
			Version:             "gpt-5.3",
			DisplayName:         "GPT 5.3",
			Description:         "Stable version of GPT 5.3 with enhanced reasoning and professional knowledge",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"none", "low", "medium", "high", "xhigh"}},
		},
		{
			...
			Description:         "Stable version of GPT 5.3 Codex, 25% faster with enhanced coding and agentic capabilities",
			ContextLength:       400000,
			MaxCompletionTokens: 128000,
			SupportedParameters: []string{"tools"},
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
...
func GetAntigravityModelConfig() map[string]*AntigravityModelConfig {
	return map[string]*AntigravityModelConfig{
		...
		"gemini-claude-opus-4-6-thinking":         {Thinking: &ThinkingSupport{Min: 1024, Max: 200000, ZeroAllowed: false, DynamicAllowed: true}, MaxCompletionTokens: 64000},
	}
}

// GetGitHubCopilotModels returns the available models for GitHub Copilot.
// These models are available through the GitHub Copilot API at api.githubcopilot.com.
// Model IDs are prefixed with "copilot-" to avoid conflicts with other providers (e.g., Codex).
// The prefix is stripped by the executor before sending requests to the GitHub Copilot API.
	...
	return []*ModelInfo{
		{
			...
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.1 Codex Mini",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.1 Codex Max",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.2",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.2 Codex",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.3",
			Description:         "OpenAI GPT-5.3 via GitHub Copilot",
			ContextLength:       128000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Levels: []string{"low", "medium", "high", "xhigh"}},
			SupportedEndpoints:  []string{"/chat/completions", "/responses"},
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot GPT-5.3 Codex",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Claude Haiku 4.5",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Claude Opus 4.5",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Claude Opus 4.6",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Gemini 3 Flash Preview",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Gemini 3 Pro Preview",
		...
		},
		{
			...
			OwnedBy:             "github-copilot",
			Type:                "github-copilot",
			DisplayName:         "GitHub Copilot Raptor Mini",
